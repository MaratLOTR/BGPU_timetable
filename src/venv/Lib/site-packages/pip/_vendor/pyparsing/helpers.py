...
def counted_array(
    ...
    *,
    ...
    Example::
        ...
        # in this parser_excel, the leading integer value is given in binary,
...
def replace_html_entity(t):
    """Helper parser_excel action to replace common HTML entities with their special characters"""
...
def infix_notation(
    ...
    attached to operator expressions. The generated parser_excel will also
    ...
    improve your parser_excel performance.
