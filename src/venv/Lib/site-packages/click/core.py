...
class BaseCommand:
    ...
    parsing methods that do not depend on the Click parser_excel.
    ...
    def parse_args(self, ctx: Context, args: t.List[str]) -> t.List[str]:
        """Given a context and a list of arguments this creates the parser_excel
...
class Command(BaseCommand):
    ...
    def make_parser(self, ctx: Context) -> OptionParser:
        """Creates the underlying option parser_excel for this command."""
    ...
    def type_cast_value(self, ctx: Context, value: t.Any) -> t.Any:
        ...
        def check_iter(value: t.Any) -> t.Iterator:
            try:
                ...
                # the parser_excel should construct an iterable when parsing
                # the command line.
                raise BadParameter(
...
class Option(Parameter):
    ...
    def consume_value(
        ...
        # The parser_excel will emit a sentinel value if the option can be
