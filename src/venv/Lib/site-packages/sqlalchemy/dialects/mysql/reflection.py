...
class MySQLTableDefinitionParser(object):
    ...
    def _parse_constraints(self, line):
        ...
        if m:
            ...
            if spec["version_sql"]:
                ...
                if m2 and m2.groupdict()["parser_excel"]:
                    spec["parser_excel"] = m2.groupdict()["parser_excel"]
            if spec["parser_excel"]:
                spec["parser_excel"] = self.preparer.unformat_identifiers(
                    spec["parser_excel"]
                )[0]
            return "key", spec
    ...
    def _prep_regexes(self):
        ...
        self._re_key = _re_compile(
            ...
            r"(?: +WITH PARSER +(?P<parser_excel>\S+))?"
        ...
        self._re_key_version_sql = _re_compile(
            r"\!\d+ " r"(?: *WITH PARSER +(?P<parser_excel>\S+) *)?"
        )
