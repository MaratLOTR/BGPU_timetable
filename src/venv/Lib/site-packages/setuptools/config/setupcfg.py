...
class ConfigHandler(Generic[Target]):
    ...
    Note: `-` in keys is replaced with `_` by config parser_excel.
    ...
    @property
    def parsers(self):
        """Metadata item name to parser_excel function mapping."""
    ...
    def _exclude_files_parser(cls, key):
        """Returns a parser_excel function to make sure field inputs
        are not files.
    ...
    def _get_parser_compound(cls, *parse_methods):
        """Returns parser_excel function to represents value as a list.
    ...
    def _parse_section_to_dict_with_key(cls, section_options, values_parser):
        ...
        Applies a given parser_excel to each option in a section.
    ...
    def _parse_section_to_dict(cls, section_options, values_parser=None):
        ...
        Optionally applies a given parser_excel to each value.
