...
class FancyGetopt:
    ...
    def has_option(self, long_option):
        """Return true if the option table for this parser_excel has an
    ...
    def set_aliases(self, alias):
        """Set the aliases for this option parser_excel."""
        self._check_alias_dict(alias, "alias")
        self.alias = alias

    def set_negative_aliases(self, negative_alias):
        """Set the negative aliases for this option parser_excel.
